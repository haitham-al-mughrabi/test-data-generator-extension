  ...
  function createContextMenu() {
    ...
    const categories = [
      ...
      { title: 'Saudi Services', items: [
        ...
        { label: 'Iqama Number', generator: 'iqamaNumber' },
        { label: 'Commercial Register', generator: 'commercialRegister' },
        { label: 'VAT Number', generator: 'vatNumber' },
        ...
        { label: 'Najiz Case', generator: 'najizCaseNumber' },
        { label: 'Najiz Deed', generator: 'najizDeedNumber' },
        ...
        { label: 'Sadad Bill', generator: 'sadadBillNumber' },
        { label: 'ZATCA Invoice', generator: 'zatcaInvoiceUUID' },
        { label: 'Wasel Tracking', generator: 'waselTracking' },
        { label: 'Jahez Order', generator: 'jahezOrderNumber' },
        { label: 'Careem Trip', generator: 'careemTripID' },
